...
SECRET_KEY = 'django-insecure-6sicu+gb&sx_dceeod)%n%r=b6gvfc8=0e5mw61umwrg614%#l'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'cubex',  # Имя вашей базы данных
...
DJOSER = {
    ...
    'SERIALIZERS': {
        'user_create': 'cubexmain.serializers.CustomUserCreateSerializer',
        'user': 'cubexmain.serializers.CustomUserSerializer',
    },
}
